...
namespace SignalR.DAL.Migrations
{
    ...
    [Migration("20240424142246_mig_add_messages_table")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SignalR.Entity.Entities.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SignalR.Entity.Entities.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SignalR.Entity.Entities.Message", b =>
                {
            ...
            modelBuilder.Entity("SignalR.Entity.Entities.Notification", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("SignalR.Entity.Entities.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("SignalR.Entity.Entities.AppUser", null)
                        .WithMany()
